...
<section id="social plugin" class="wrapssss" >
	...
	<p>The plugin maps are made to be self-contained. On your <a href="<?=admin_url().'admin.php?page=my-maps'?>">MyMaps</a> page, you can download your maps if you wish to use them outside of WordPress.</p>
	...
	<p align="center">Copyright @ <?PHP date('Y'); ?> <a href="http://www.acugis.com/" target="_blank">AcuGIS</a></p>
