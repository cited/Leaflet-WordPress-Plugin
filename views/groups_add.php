<?PHP
	...
	<ol class="breadcrumb breadcrumb-arrow" style="margin: 10px 15px 0 0;">
		...
		<li class="active"><span><i class="fa fa-plus"></i> Add New Group</span></li>
		...
		<div class="col-md-12">
			<div class="wrap">
				<div class="settingContent">
						...
						<br>
						<input type="text" class="form-control" required="required" name="name" value="<?php if(isset($_POST['name']) && $_POST['name']!='') echo $_POST['name']; ?>">
						</div>
